...
Also `Frame` annd `Gif` inside `@Resource` folder is empty because the file is too big, it is supposedly where you put your `*gif` file. Refer to [`Rainmeter Gif`](https://docs.rainmeter.net/tips/animated-gif-files/) for more information.
